...
getMCArea <- function(f,xinf,xsup,n){
    ...
    # Calculamos la proporción de puntos dentro de la curva respecto al total de puntos lanzados
    ...
    # Multiplicamos la proporción de puntos debajo de la curva por el área total del rectángulo
...
cat("Estimación de la integral de f(x) mediante el método de Monte Carlo:", integral_estimate, "\n")
...
cat("Tamaño de muestra necesario para alcanzar el error máximo de +-0.001$ = ", n, ",con área = ", curr_area)
